...
class Tag:
    ...
    def __init__(
        ...
        Args:
            ...
            attrs: Optional dict with tag attributes (id, class, etc).
            text: Optional text fo the tag.
            children: Optional list of the child tags.
        """
...
class Component(Protocol):
    """More complex tag composition tied to general logic and/or state.
